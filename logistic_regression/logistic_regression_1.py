...
X_new = np.linspace(0,3,1000).reshape(-1,1) #注意积累reshape的作用
# print(X_new)
...
plt.plot(X_new, y_proba[:,1], 'b-', label='Iris-Versicolour')
plt.plot(X_new, y_proba[:,0], 'y-', label='Iris-Setosa')
plt.show()
